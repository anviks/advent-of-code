...
def part1():
    ...
    for (cell_a, cost_a), (cell_b, cost_b) in combinations(costs.items(), 2):
        if cell_a.manhattan_distance(cell_b) == 2 and abs(cost_a - cost_b) - 2 >= 100:
            acc += 1
...
def part2():
    ...
    for (cell_a, cost_a), (cell_b, cost_b) in combinations(costs.items(), 2):
        cheating_len = cell_a.manhattan_distance(cell_b)
        if 1 <= cheating_len <= 20 and abs(cost_a - cost_b) - cheating_len >= 100:
            acc += 1
...
if __name__ == '__main__':
    ...
    print(part2())  # 1015092   | 9.22 seconds
