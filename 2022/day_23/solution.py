...
for t in range(10000):
    ...
    for (r, c) in E:
        ...
        for dir_ in dir_list:
            if dir_ == 'N' and (not moved) and (r - 1, c) not in E and (r - 1, c - 1) not in E and (
            r - 1, c + 1) not in E:
                P[(r - 1, c)].append((r, c))
                moved = True
            elif dir_ == 'E' and (not moved) and (r + 1, c) not in E and (r + 1, c - 1) not in E and (
            r + 1, c + 1) not in E:
                P[(r + 1, c)].append((r, c))
                moved = True
            elif dir_ == 'S' and (not moved) and (r, c - 1) not in E and (r - 1, c - 1) not in E and (
            r + 1, c - 1) not in E:
                P[(r, c - 1)].append((r, c))
                moved = True
            elif dir_ == 'W' and (not moved) and (r, c + 1) not in E and (r - 1, c + 1) not in E and (
            r + 1, c + 1) not in E:
                P[(r, c + 1)].append((r, c))
                moved = True
